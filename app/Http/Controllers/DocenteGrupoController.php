...
class DocenteGrupoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return  redirect()->route('docentes_grupos.index')->with('success', 'Docente grupo creado');
    }
     ...
     */
    /**cómo se muestra el formulario para editar el recurso especificado. */
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('succes','Docente grupo actualizado correctamente');
    }
